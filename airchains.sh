...
/data/airchains/tracks/build/tracks create-station --accountName $id --accountPath $HOME/.tracks/junction-accounts/keys --jsonRPC "https://t-airchains.rpc.utsa.tech/" --info "EVM Track" --tracks "$add" --bootstrapNode "$bootstrapNode"
